AFRAME.registerComponent("info-banner", {
    ...
    createBanner: function () {
      postersInfo = {
        ...
        "x-men": {
          banner_url: "./assets/OIP (2).jpeg",
          title: "X-men",
          released_year: "1962",
          description:
            "X-men are the superhero group that opposes the avengers. It is recommended if you are a marvel fennetic.",
        },
        "captain-aero": {
          banner_url: "./assets/OIP (3).jpeg",
          title: "Captain Aero",
          released_year: "1942",
          description:
